...
# Not sure yet whether I am using exceptions and logging levels correctly
logging.basicConfig(
    level=logging.DEBUG,
    format='%(asctime)s - %(levelname)s - %(message)s'
)

# Project title - I have only learned dict so far,
# so all code is temporarily kept in a single file
