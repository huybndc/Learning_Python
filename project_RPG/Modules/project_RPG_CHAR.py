# Đang bị thiếu docstrings ở phần mở đầu và ở tất cả các functions
...
class Character:
    ...
    # Giữa các def thì nên cách 2 ô - PEP8
    ...
    #Đang không tách biệt cụ thể giữa 2 magic functions
    def __repr__(self):
        return f'{self.ID:8} - {self.hp:3}/{self.max_hp:3} - atk : {self.atk}'
...
class Warrior(Character):
    ...
    def critical_strike(self, target: 'Character'):
        # 1. tính damage
        # Magic number - Con số 1.7 này đáng nhẽ nên nằm trong Config
        damage = self.atk * 1.7
